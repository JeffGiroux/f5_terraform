...
output "mgmt_pip_url" { value = "https://${google_compute_instance.f5vm01.network_interface.1.access_config.0.nat_ip}" }
output "mgmt_name" { value = google_compute_instance.f5vm01.name }
