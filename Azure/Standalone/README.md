...
terraform apply
```
  4. At this time, you have a new standalone BIG-IP VE deployed but still requires DO and AS3.
...
- This example illustrates how to re-configure the BIG-IP instance with DO. If you need to make changes to the L1-L3 settings of the BIG-IP device, you can follow these steps.
```
